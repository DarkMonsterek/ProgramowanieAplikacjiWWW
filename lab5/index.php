...
<body bgcolor="#0d1b2a" onload="startclock()">
    ...
    if ($_GET['idp'] == 'burj_khalifa')
        $strona = 'html/burj_khalifa.html';
    elseif ($_GET['idp'] == 'merdeka_118')
        $strona = 'html/merdeka_118.html';
    elseif ($_GET['idp'] == 'shanghai_tower')
        $strona = 'html/shanghai_tower.html';
    elseif ($_GET['idp'] == 'abraj_al_bait')
        $strona = 'html/abraj_al_bait.html';
    elseif ($_GET['idp'] == 'ping_an')
        $strona = 'html/ping_an.html';
    elseif ($_GET['idp'] == 'filmy')
        $strona = 'html/filmy.html';
    elseif ($_GET['idp'] == '' || $_GET['idp'] == 'glowna')
