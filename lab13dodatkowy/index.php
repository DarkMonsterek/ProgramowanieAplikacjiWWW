...
$userManager = new UserManager($link, $cart);
?>
<!DOCTYPE html>
<html lang="pl">
        ...
        <div class="container header-container">
            ...
            <nav class="main-nav">
                <ul>
                    ...
                    <li><a href="index.php?idp=konto"
                            class="<?php echo ($_GET['idp'] == 'konto') ? 'active' : ''; ?>">Konto</a></li>
                </ul>
            </nav>
        </div>
    </header>
    ...
    if (empty($_GET['idp'])) {
        ...
        switch ($_GET['idp']) {
            ...
            case 'produkt':
                ...
                if (isset($_GET['id'])) {
                    PokazProdukt($link, $cart, $_GET['id']);
                } else {
                    echo '<h2>Brak identyfikatora produktu.</h2>';
                }
                break;
            case 'sklep':
                // Wyświetlenie sklepu
