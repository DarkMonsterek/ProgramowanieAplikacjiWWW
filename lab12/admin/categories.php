    ...
    public function PokazKategorie()
    {
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '<a href="admin.php?type=categories&action=edit&edit_id=' . $row['id'] . '" class="action-btn">[Edytuj]</a> ';
                echo '<a href="admin.php?type=categories&action=delete&delete_id=' . $row['id'] . '" class="action-btn" onclick="return confirm(\'Czy na pewno usunąć?\')">[Usuń]</a>';
    ...
    private function PokazPodkategorie($parentId)
    {
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '<a href="admin.php?type=categories&action=edit&edit_id=' . $row['id'] . '" class="action-btn" style="padding: 2px 5px; font-size: 0.8em;">[Edytuj]</a> ';
                echo '<a href="admin.php?type=categories&action=delete&delete_id=' . $row['id'] . '" class="action-btn" style="padding: 2px 5px; font-size: 0.8em;" onclick="return confirm(\'Czy na pewno usunąć?\')">[Usuń]</a>';
                echo '</li>';
            }
            echo '</ul>';
        }
