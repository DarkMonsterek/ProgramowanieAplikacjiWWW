...
class Produkty
{
    ...
    public function PokazProdukty()
    {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo '<td>';
            echo '<td>';
            echo '<a href="admin.php?type=products&action=edit&edit_id=' . $row['id'] . '" class="action-btn">[Edytuj]</a> ';
            echo '<a href="admin.php?type=products&action=delete&delete_id=' . $row['id'] . '" class="action-btn" onclick="return confirm(\'Czy na pewno usunąć?\')">[Usuń]</a>';
            echo '</td>';
            echo '</tr>';
        }
        echo '</table>';
